				...
				<div className="container flex items-center py-12 mx-auto">
					<div className="w-1/2 pr-8">
						...
						<p className="mb-6 text-lg">
							...
							provident itaque pariatur eaque ipsam suscipit. Soluta aliquam
							quaerat inventore fugit praesentium? Delectus, magni cum nostrum
							eos voluptatibus facilis esse harum libero consequuntur.
						</p>
			...
			<div className="container py-8 mx-auto">
				<div className="text-center">
					...
					<p className="mb-8 text-lg">
						Discover delicious recipes that are easy to make and packed with
						flavor.
					</p>
				</div>
			</div>
